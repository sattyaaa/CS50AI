...
def pass_prob(parent, one_gene, two_genes):
...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] is None:
            ...
            pass_from_dad = pass_prob(father, one_gene, two_genes)
            pass_from_mother = pass_prob(mother, one_gene, two_genes)

            if gene_count==2:
                gene_prob = pass_from_dad*pass_from_mother
            elif gene_count==1:
                gene_prob = pass_from_mother*(1-pass_from_dad) + pass_from_dad*(1-pass_from_mother)
            else:
                gene_prob = (1-pass_from_mother)*(1-pass_from_dad)
